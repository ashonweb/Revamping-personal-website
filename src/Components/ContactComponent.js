  ...
  return (
    <section className={classes.section}>
      <div className={classes.inner}>
        ...
        <a href="mailto:bhagyameghpal14@gmail.com" className={classes.emailLink}>
          bhagyameghpal14@gmail.com
        </a>

        <div className={classes.socials}>
          <a href="https://github.com/ashonweb" target="_blank" rel="noreferrer" className={classes.socialPill}>
            <GitHubIcon /> GitHub
          </a>
          <a href="https://www.linkedin.com/in/bhagyashree-meghpal-1175a0163/" target="_blank" rel="noreferrer" className={classes.socialPill}>
            <LinkedInIcon /> LinkedIn
          </a>
          <a href="https://twitter.com/meghpalbhagya" target="_blank" rel="noreferrer" className={classes.socialPill}>
            <TwitterIcon /> Twitter
          </a>
        </div>
      </div>
