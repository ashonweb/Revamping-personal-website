...
const PROJECTS = [
  ...
  {
    title: 'Launch Log',
    desc: 'Global space mission history from 1957–2024 across 11 agencies. Features filtering, year sort, mission detail modals with real images, and a launches-per-year chart.',
    tags: ['React', 'NASA API'],
    live: 'https://spacex-kr7e.vercel.app/',
    github: 'https://github.com/ashonweb/spacex',
    image: spacex,
  },
  {
    title: 'Face Detect',
    desc: 'In-browser biometric analysis — detects age, gender, 7 expressions, head pose and smile intensity in real time via webcam or uploaded image. No API key required.',
    tags: ['React', 'face-api.js', 'TensorFlow.js'],
    live: 'https://face-detection-app-kohl.vercel.app/',
    github: 'https://github.com/ashonweb/FaceDetectionApp',
    image: face,
  },
  {
    title: 'Hacker News Clone',
    desc: 'Dark-themed HN reader with live Algolia API data. Top/New/Ask/Show tabs, upvote, hide, paginated buffer that auto-refills from the next page, color-coded points and timestamps.',
    tags: ['React 18', 'Algolia API'],
    live: 'https://hacker-news-murex-mu.vercel.app/',
  ...
  },
  {
    ...
    desc: 'Deep space strategy game built in Svelte. 5-mission campaign with escalating difficulty — time limits, damaged fleets, nav blackouts. Scanning reveal sequence, score system, and a connected story that follows Queen Al Falcone across the galaxy.',
    tags: ['Svelte', 'Geektrust API'],
    live: 'https://falcon-application.vercel.app/',
    github: 'https://github.com/ashonweb/falcon_application',
    image: falcon,
  },
  {
    title: 'Drum Machine',
    desc: '16-pad MPC-style beat maker with a 16-step sequencer, step velocity, swing, per-pad pitch, pattern slots, reverb, waveform visualizer, and shareable pattern URLs.',
    tags: ['React', 'Web Audio API'],
    live: 'https://drum-machine-beige-phi.vercel.app/',
