      ...
      <div className={classes.container}>
        ...
        <div className="grid" style={{ margin: '10px 0' }}>
          <ul id="hexGrid">
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="http://ice-n-fire.surge.sh/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${got})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink"  rel="noreferrer" href="http://spacex_bmeghpal.surge.sh/#/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${spacex})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="http://ice-n-fire.surge.sh/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${falcon})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="http://hacker-news-alt.surge.sh/#/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${hacknews})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="https://wiki-bmeghpal-viwer.surge.sh/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${wiki})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href=" https://drums_appliction.surge.sh" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${drums})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="https://diamond-game.surge.sh/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${diamond})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="https://bmeghpal-face-detect.surge.sh/#/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${face})`, }}></div>
            ...
            <li className="hex">
              <div className="hexIn">
                <a className="hexLink" rel="noreferrer" href="https://calculator-bmeghpal.surge.sh/" target='_blank'>
                  <div className='img' style={{ backgroundImage: `url(${calc})`, }}></div>
